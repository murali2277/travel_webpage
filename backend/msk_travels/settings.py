...
SECRET_KEY = config(
    'SECRET_KEY',
    default='django-insecure-msk-travels-secret-key-change-in-production'
)
...
WSGI_APPLICATION = 'msk_travels.wsgi.application'
...
EMAIL_HOST_USER = config('EMAIL_HOST_USER',
                         default='0904muralikumar@gmail.com')
